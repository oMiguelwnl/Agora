  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Ágora?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Ágora, the premier programming community dedicated to
          helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Ágora, I know firsthand the challenges that
          come with learning and growing in the programming industry.
          That&apos;s why I created Ágora &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Ágora, we believe that price should never be a barrier to achieving
          ...
          <br />
          <br />
          But Ágora is more than just a community &ndash; we&apos;re a family.
          ...
          <br />
          <br />
          With Ágora by your side, there&apos;s nothing standing between you and
          ...
          <br />
          <br />
          So what are you waiting for? Join the Ágora family today and
        ...
        <br />
        <span className="text-[22px]">Miguel&apos;s</span>
        <h5 className="text-[18px] font-Poppins">Founder and CEO of Ágora</h5>
        <br />
        <br />
        <br />
      </div>
